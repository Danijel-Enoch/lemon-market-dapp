	...
	return (
		<div className="bg-slate-900 border border-slate-800 rounded-lg">
			<Tabs defaultValue="open" className="w-full">
				<TabsList className="bg-transparent border-b border-slate-800 rounded-none p-0 h-auto w-full justify-start">
					<TabsTrigger
						value="open"
						className="bg-transparent text-white text-sm font-medium border-b-2 border-transparent data-[state=active]:border-blue-500 data-[state=active]:text-blue-400 rounded-none px-6 py-3"
					>
