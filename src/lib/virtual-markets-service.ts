...
class VirtualMarketsService {
	...
	constructor() {
		this.subgraphUrl = import.meta.env.VITE_SUBGRAPH_URL || "";
	}
	...
	private marketCacheTTLMs = Number(import.meta.env.VITE_VIRTUAL_MARKETS_CACHE_TTL_MS || 60000);
	...
	private async makeGraphQLRequest(
		...
		const response = await fetchWithTimeout(
			...
			Number(import.meta.env.VITE_SUBGRAPH_FETCH_TIMEOUT_MS || 6000),
		);
