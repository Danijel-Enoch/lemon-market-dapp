                        ...
                        <CardContent className="p-12 text-center">
                            <div className="mb-8">
                                ...
                                <h2 className="text-3xl font-bold text-foreground mb-4">
                                    Staking is on the Way
                                </h2>
                                <p className="text-muted-foreground text-lg max-w-lg mx-auto">
                                    We're building a powerful staking platform
                                    to help you earn passive income on your
                                    tokens
                                </p>
                            </div>
                        </CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Card className="bg-card border-gray-100/10">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Earn attractive returns on your staked
                                    tokens
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-card border-gray-100/10">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Your funds protected by smart contract
                                    security
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-card border-gray-100/10">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Choose staking periods that fit your
                                    strategy
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <CardContent className="p-6">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-white/80 mb-2">
                                    Contact the development team to learn more
                                    about staking opportunities
                                </p>
