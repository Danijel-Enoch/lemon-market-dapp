...
export default function PositionsPage() {
	...
	const winRate =
		displayPositions.length > 0
			? (profitablePositions / displayPositions.length) * 100
			: 0;
		...
		<div className="min-h-screen bg-black text-white p-4 md:p-8">
			<div className="max-w-screen-2xl mx-auto space-y-8">
					...
					<div className="flex items-center justify-between">
						...
						<div className="flex items-center gap-3">
							<Button
								...
								disabled={isLoading}
								className="border-lime-500/20 hover:border-lime-500/40"
							>
								<RefreshCw
				...
				>
					...
					<Card className="bg-gray-900/50 border-gray-800">
						...
						<CardContent>
							...
							{isEnhancedMode && (
								<div className="text-sm text-gray-400 mt-1">
									Unrealized: $
									{totalUnrealizedPnL?.toFixed(2) || "0.00"}
								</div>
							)}
						</CardContent>
					</Card>
					...
					<Card className="bg-gray-900/50 border-gray-800">
						...
						<CardContent>
							...
							<div className="text-sm text-gray-400 mt-1">
								{profitablePositions}/{displayPositions.length}{" "}
								profitable
							</div>
						</CardContent>
					</Card>
				...
				{isEnhancedMode && (
					...
					>
						<Card className="bg-gradient-to-r from-lime-500/10 to-emerald-500/10 border-lime-500/20">
							<CardContent className="p-4">
								<div className="flex items-center gap-3">
									...
									<p className="text-sm text-gray-300">
										Real-time PnL calculations powered by
										Lemon Oracle with micro-precision
										pricing
									</p>
								</div>
							</CardContent>
