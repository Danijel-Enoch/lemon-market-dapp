        ...
        {results.length > 0 && (
          <div className="p-3 border-t border-primary/30 bg-muted/10 rounded-b-xl">
            <div className="text-xs text-muted-foreground text-center">
              Found {results.length} results on Base network from DexScreener
              and GeckoTerminal
            </div>
          </div>
        )}
...
// import { SearchResultsContainer, SearchResultsTable } from "./SearchResults";
...
//     { key: "exchange", label: "Exchange/Chain" },
...
//       loadingMessage="Searching across multiple exchanges..."
//     >
//       <SearchResultsTable
//         columns={columns}
//         data={results}
...
//             <td className="p-3">{formatPrice(result.priceUsd)}</td>
...
//             <td className="p-3">{formatVolume(result.volume24h)}</td>
//             <td className="p-3">{formatVolume(result.liquidity)}</td>
...
//         )}
//         footer={
//           <div className="p-3 border-t border-primary/30 bg-muted/10 text-xs text-center">
//             Found {results.length} results from DexScreener & GeckoTerminal
//           </div>
//         }
//       />
//     </SearchResultsContainer>
