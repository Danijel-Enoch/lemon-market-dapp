	...
	return (
		<section className="py-16 px-6 md:px-10 max-w-5xl mx-auto text-center">
			{/* <div className="inline-flex items-center gap-8">
				...
				/>
				<span className="text-[#9DEA29] font-medium text-sm leading-[19px]">
					Features
				</span>
				<img
					src="/assets/homepage/section-features-divider.png"
			...
			{/* <h3 className="mt-6 text-3xl md:text-4xl font-medium bg-linear-to-r from-white to-gray-300 bg-clip-text text-transparent">
